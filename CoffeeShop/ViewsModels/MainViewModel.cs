    ...
    public partial class MainViewModel : ObservableObject
    {
        ...
        private static IEnumerable<Offer> LoadDummyOffers()
        {
            return new List<Offer>
            {
                ...
                new Offer(3, "Up to 25% OFF", "uptp_25_percent.png", "Upto 25 OFF", "UPTO-25", OfferType.Percentage, 25, 500, null),
                new Offer(4, "Half Price", "half_price.png", "Half Price", "HALF", OfferType.Percentage, 50, 1000, DateTime.Now.AddDays(2)),
                ...
                new Offer(6, "30% OFF", "thirty_percent.png", "50", "OFF", OfferType.Percentage, 30, 300, DateTime.Now.AddMonths(1)),
                ...
                new Offer(8, "SALE 40% OFF", "sale_40_percent.png", "SALE 40% OFF", "SALE-40", OfferType.Percentage, 40, null, DateTime.Now.AddDays(4)),
